...
public class AddEventTest {
	 String brideName,groomName,date,time,venue, location,phone;
	    int numberOfGuests;
    ...
    public void thereIsAnEventWithBrideNameGroomNameDateTimeNumberOfGuestsVenueLocationAndPhone(String string, String string2, String string3, String string4, String string5, String string6, String string7, String string8) {
        eventManagement.createWeddingEvent(brideName, groomName, date, time, numberOfGuests, venue, location, phone);
}
    ...
    public void theSystemShouldNotAllowAddingTheEventAndDisplayAMessageAboutTheVenueBeingAlreadyBooked() {
        Assert.assertEquals("Venue is already booked", eventManagement.getErrorMessage());
    ...
    public void theUserTriesToAddANewEventWithBrideNameGroomNameDateTimeNumberOfGuestsVenueLocationAndPhone(String brideName, String groomName, String date, String time, String numberOfGuests, String venue, String location, String phone) {
        eventManagement.createWeddingEvent("Bride5", "Groom5", "2024-05-20", "10:00 AM", 250, "Venue3", "Location1", "123456789");
    }
